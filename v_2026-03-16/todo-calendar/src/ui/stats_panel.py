...
class StatsPanel(QWidget):
    ...
    def _create_basic_stats(self, parent_layout):
        ...
        # 总任务数
        self.total_label = self._create_stat_item("总任务", "0")
        stats_layout.addWidget(self.total_label, 0, 0)
        
        # 已完成
        self.completed_label = self._create_stat_item("已完成", "0", "#27ae60")
        stats_layout.addWidget(self.completed_label, 0, 1)
        
        # 待办
        self.pending_label = self._create_stat_item("待处理", "0", "#f39c12")
        stats_layout.addWidget(self.pending_label, 1, 0)
        
        # 完成率
        self.rate_label = self._create_stat_item("完成率", "0%")
    ...
    def _create_progress_section(self, parent_layout):
        ...
        self.total_progress.setFormat("%p% 完成")
    ...
    def _create_productivity_score(self, parent_layout):
        ...
        # 说明文字
        desc_label = QLabel("基于完成率、优先级和逾期任务计算")
